...
const sections = [
    {
        ...
        body: `By accessing or using Trendko (the "Platform"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Platform. These Terms apply to all users, including brands, creators, and visitors.`,
    },
    {
        title: '2. Description of Service',
        body: `Trendko is a viral content marketing platform that connects brands with creators through three campaign types: Contest (brand selects a winner), Ripple (CPM-based pay-per-view), and Pitch (creator-initiated brand deals). View counts are verified directly through official platform APIs — no self-reporting.`,
    },
    {
        title: '3. Eligibility',
    ...
    {
        title: '4. Accounts',
        body: `You are responsible for maintaining the confidentiality of your login credentials and for all activities that occur under your account. Notify us immediately at support@trendko.com if you suspect unauthorised access. We reserve the right to terminate accounts that violate these Terms.`,
    },
    {
    ...
    },
    {
        ...
        body: `Brands are responsible for the legality and accuracy of their campaign briefs. Campaigns must not promote illegal products, hate speech, or misleading claims. Trendko reserves the right to reject, pause, or remove any campaign at its discretion. Escrow funds are collected before a campaign goes live and may only be refunded in the circumstances described in these Terms.`,
    },
    {
        title: '8. Content & Intellectual Property',
        body: `Creators retain ownership of content they produce. By submitting content through the Platform, creators grant Trendko and the sponsoring brand a non-exclusive, royalty-free licence to display and promote that content in connection with the campaign. Brands retain ownership of their campaign briefs, logos, and brand assets. Neither party may use the other's content outside the scope of the campaign without express written consent.`,
    },
    {
    ...
    },
    {
        ...
        body: `View counts are pulled automatically from official platform APIs (TikTok, Instagram, YouTube) every six hours. Creators acknowledge that API data is authoritative for payout calculations. Trendko is not responsible for delays or discrepancies caused by third-party API outages. Disputes must be raised within 14 days of the relevant payout event.`,
    },
    {
        title: '11. Dispute Resolution',
        body: `In the event of a dispute between a brand and a creator, both parties agree to first attempt resolution through the Platform's messaging system. If unresolved within 7 days, either party may escalate to Trendko's support team. Trendko's decision on platform-level disputes (e.g., fraudulent views, brief violations) is final and binding. Legal disputes shall be governed by the laws of the jurisdiction in which Trendko is incorporated.`,
    },
    {
        title: '12. Limitation of Liability',
        body: `To the fullest extent permitted by law, Trendko shall not be liable for indirect, incidental, special, or consequential damages arising from your use of the Platform. Our total liability to you for any claim shall not exceed the fees you paid to us in the 3 months preceding the claim.`,
    },
    {
        title: '13. Indemnification',
        body: `You agree to indemnify and hold harmless Trendko, its officers, employees, and partners from any claims, damages, or expenses (including legal fees) arising from your use of the Platform, your content, or your violation of these Terms.`,
    },
    {
    ...
    {
        title: '15. Contact',
        body: `Questions about these Terms? Email us at info@trendnko.com or write to: Trendnko, 4009 Cane Garden Dr, Raleigh, NC US.`,
    },
];
...
export default function Terms() {
    return (
        <>
            <Head title="Terms of Service — Trendko" />
