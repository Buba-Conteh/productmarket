    ...
    return (
        <>
            ...
            <div className="space-y-6 px-4 py-6">
                <Heading
                    title="My Analytics"
                    description="Your views, earnings, and performance over time."
                />
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <StatCard
                        label="Pending"
                        value={`$${summary.pending_earnings.toLocaleString()}`}
                        icon={BarChart3}
                    />
                    <StatCard
                        label="Entries"
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Views — Last 12 Weeks</CardTitle>
                    </CardHeader>
                    <CardContent>
                        {weekly_snapshots.length === 0 ? (
                            <p className="py-8 text-center text-sm text-muted-foreground">
                                No data yet. Get some entries live to track
                                views.
                            </p>
                        ) : (
                ...
                <div className="grid gap-4 lg:grid-cols-2">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Top Entries by Views</CardTitle>
                        </CardHeader>
                        <CardContent>
